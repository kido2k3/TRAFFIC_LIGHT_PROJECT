...
#define TL_GREEN_PORT1 GPIOB // Traffic light 1st
#define TL_GREEN1 GPIO_PIN_10
#define TL_RED_PORT1 GPIOB // Traffic light 1st
#define TL_RED1 GPIO_PIN_4

#define TL_PORT2 GPIOB // Traffic light 2nd
#define TL_GREEN2 GPIO_PIN_5
#define TL_RED2 GPIO_PIN_3

#define TL_PED_GREEN_PORT GPIOC // Pedestrian light
#define TL_PED_GREEN GPIO_PIN_7
